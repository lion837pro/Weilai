...
public class Rotation{
     ...
     */
    public static final Rotation kZero = new Rotation();
     ...
     * <p>This exists to avoid allocations for common rotations.
     */
    public static final Rotation kCW_Pi_2 = new Rotation(-Math.PI / 2);
     ...
     * <p>This exists to avoid allocations for common rotations.
     */
    public static final Rotation kCW_90deg = kCW_Pi_2;
     ...
     * <p>This exists to avoid allocations for common rotations.
     */
    public static final Rotation kCCW_Pi_2 = new Rotation(Math.PI / 2);
     ...
     * <p>This exists to avoid allocations for common rotations.
     */
    public static final Rotation kCCW_90deg = kCCW_Pi_2;
     ...
     * <p>This exists to avoid allocations for common rotations.
     */
    public static final Rotation kPi = new Rotation(Math.PI);
     ...
     * <p>This exists to avoid allocations for common rotations.
     */
    public static final Rotation k180deg = kPi;
    ...
    /**
     * Converts the Rotation2d to an Angle.
     *
     * @return The Angle representation of the Rotation2d.
     */
    public Angle toAngle(){
        return Angle.fromRad(getRadians());
    }
    ...
    public static Rotation fromRotations(double rotations) {
        return new Rotation(Units.rotationsToRadians(rotations));
    }
    ...
    public Rotation times(double scalar) {
        return new Rotation(m_value * scalar);
    }
     ...
     * @return The new scaled Rotation2d.
     */
    public Rotation div(double scalar) {
